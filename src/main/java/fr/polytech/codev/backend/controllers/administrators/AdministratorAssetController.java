...
public class AdministratorAssetController extends AbstractController {
    ...
    public ResponseEntity get(@PathVariable("token") String token, @PathVariable("walletId") int walletId, @PathVariable("cryptocurrencyId") int cryptocurrencyId) throws InvalidTokenException, ExpiredTokenException, UnknownEntityException, UnauthorizedUserException {
        assertUserIsAdministrator(token);
    ...
    public ResponseEntity getByWallet(@PathVariable("token") String token, @PathVariable("id") int id) throws InvalidTokenException, ExpiredTokenException, UnknownEntityException, UnauthorizedUserException {
        assertUserIsAdministrator(token);
    ...
    public ResponseEntity insert(@PathVariable("token") String token, @PathVariable("walletId") int walletId, @PathVariable("cryptocurrencyId") int cryptocurrencyId, @RequestBody String data) throws InvalidTokenException, InvalidEntityException, ExpiredTokenException, UnknownEntityException, UnauthorizedUserException {
        assertUserIsAdministrator(token);
    ...
    public ResponseEntity update(@PathVariable("token") String token, @PathVariable("walletId") int walletId, @PathVariable("cryptocurrencyId") int cryptocurrencyId, @RequestBody String data) throws InvalidTokenException, InvalidEntityException, ExpiredTokenException, UnknownEntityException, UnauthorizedUserException {
        assertUserIsAdministrator(token);
    ...
    public ResponseEntity delete(@PathVariable("token") String token, @PathVariable("walletId") int walletId, @PathVariable("cryptocurrencyId") int cryptocurrencyId) throws InvalidTokenException, ExpiredTokenException, UnknownEntityException, UnauthorizedUserException {
        assertUserIsAdministrator(token);
